<template>
    <div class="relative bg-quartenary w-28 rounded-3xl m-1.5 flex flex-col">
        ...
        <div>
            <div class="h-px w-6 bg-primary my-7 mx-auto"></div>
            <button class="bg-tertiary w-20 h-20 rounded-full m-auto mb-7 flex flex-col">
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                    stroke="#385E72" class="w-12 h-12 m-auto">
                    <path stroke-linecap="round" stroke-linejoin="round" d="M15 10.5a3 3 0 11-6 0 3 3 0 016 0z" />
                    <path stroke-linecap="round" stroke-linejoin="round"
                        d="M19.5 10.5c0 7.142-7.5 11.25-7.5 11.25S4.5 17.642 4.5 10.5a7.5 7.5 0 1115 0z" />
                </svg>
            </button>
            <button class="bg-tertiary w-20 h-20 rounded-full mb-20 m-auto flex flex-col">
                <svg class="w-12 h-12 m-auto" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
